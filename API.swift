...
public struct CreatePhotoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, key: String, photoPhotographerId: GraphQLID? = nil) {
    graphQLMap = ["id": id, "key": key, "photoPhotographerId": photoPhotographerId]
  }
...
public struct ModelPhotoConditionInput: GraphQLMapConvertible {
  ...
  public init(key: ModelStringInput? = nil, and: [ModelPhotoConditionInput?]? = nil, or: [ModelPhotoConditionInput?]? = nil, not: ModelPhotoConditionInput? = nil) {
    graphQLMap = ["key": key, "and": and, "or": or, "not": not]
  }
...
public struct UpdatePhotoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, key: String? = nil, photoPhotographerId: GraphQLID? = nil) {
    graphQLMap = ["id": id, "key": key, "photoPhotographerId": photoPhotographerId]
  }
...
public struct ModelPhotoFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, key: ModelStringInput? = nil, and: [ModelPhotoFilterInput?]? = nil, or: [ModelPhotoFilterInput?]? = nil, not: ModelPhotoFilterInput? = nil) {
    graphQLMap = ["id": id, "key": key, "and": and, "or": or, "not": not]
  }
...
public final class CreatePhotoMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreatePhoto: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, key: String, photographer: Photographer? = nil, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Photo", "id": id, "key": key, "photographer": photographer.flatMap { $0.snapshot }, "createdAt": createdAt, "updatedAt": updatedAt])
      }
    ...
    public struct CreatePhotographer: GraphQLSelectionSet {
      ...
      public struct Photo: GraphQLSelectionSet {
        ...
        public struct Item: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, key: String, createdAt: String, updatedAt: String) {
            self.init(snapshot: ["__typename": "Photo", "id": id, "key": key, "createdAt": createdAt, "updatedAt": updatedAt])
          }
